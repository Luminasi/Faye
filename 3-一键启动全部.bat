...
start "RAG Backend  :8000"  cmd /k "%~dp0_start_backend.bat"
ping -n 3 127.0.0.1 >nul
start "RAG Frontend :5173"  cmd /k "%~dp0_start_frontend.bat"
...
echo        http://localhost:8000/docs  (Backend Swagger docs)
echo.
